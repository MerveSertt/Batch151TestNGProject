...
public class C02_Ignore {
    ...
    eklememiz yeterlidir.@Ignore notasyonu ile atladığımız method konsolda gözükmez raporlamalarda gözükür
        Eğer methodu tamamen iptal etmek isterseniz @Test notasyonunundan sonra parametre olarak (enabled = false) kullanabilirsiniz.
    Böylece hem raporlamada hem de konsolda gözükmez.
     */
    @Ignore
    @Test
